...
import { getContext, runWithContext, setContext, TRACE_CONTEXT_KEY, } from "./context.js";
/** W3C のヘッダ名 */
...
export function headerValue(headers, name) {
    ...
    if (typeof headers.get === "function" && !(headers instanceof Map)) {
 ...
 */
export function formatTraceparent(trace) {
    if (trace.spanId === undefined || trace.sampled === undefined)
        return undefined;
